...
OCIType_ for the named data type being defined.  The TDO can be retrieved
...
alias OCICallbackInBind = int function (
    void* ictxp,
    OCIBind* bindp,
    ub4 iter,
    ub4 index,
...
alias OCICallbackOutBind = int function (
    void* octxp,
    OCIBind* bindp,
    ub4 iter,
    ub4 index,
...
alias OCICallbackDefine = int function (
    void* octxp,
    OCIDefine* defnp,
    ub4 iter,
    void** bufpp,
...
alias OCIUserCallback = int function (
    void* ctxp,
    void* hndlp,
    ub4 type,
    ub4 fcode,
...
alias OCIEnvCallbackType = int function (
    OCIEnv* env,
    ub4 mode,
    size_t xtramem_sz,
    void* usrmemp,
...
alias OCICallbackLobRead = int function (
    void* ctxp,
    const(void)* bufp,
    ub4 len,
    ub1 piece);

alias OCICallbackLobWrite = int function (
    void* ctxp,
    void* bufp,
    ub4* lenp,
    ub1* piece);

alias OCICallbackLobRead2 = int function (
    void* ctxp,
    const(void)* bufp,
    oraub8 len,
    ub1 piece,
...
alias OCICallbackLobWrite2 = int function (
    void* ctxp,
    void* bufp,
    oraub8* lenp,
    ub1* piece,
...
alias OCICallbackLobArrayRead = int function (
    void* ctxp,
    ub4 array_iter,
    const(void)* bufp,
    oraub8 len,
...
alias OCICallbackLobArrayWrite = int function (
    void* ctxp,
    ub4 array_iter,
    void* bufp,
    oraub8* lenp,
...
alias OCICallbackLobGetDeduplicateRegions = int function (
    void* ctxp,
...
alias OCICallbackAQEnq = int function (
    void* ctxp,
    void** payload,
    void** payload_ind);

alias OCICallbackAQEnqStreaming = int function (
    void* ctxp,
    void** payload,
    void** payload_ind,
...
alias OCICallbackAQDeq = int function (
    void* ctxp,
    void** payload,
    void** payload_ind);

/*--------------------------Failover Callback Structure ---------------------*/
alias OCICallbackFailover = int function (
    void* svcctx,
    void* envctx,
    void* fo_ctx,
    ub4 fo_type,
...
alias OCICallbackStmtCache = int function (void* ctx, OCIStmt* stmt, ub4 mode);

/*--------------------------HA Callback Structure ---------------------*/
alias OCIEventCallback = void function (void* evtctx, OCIEvent* eventhp);
...
sword OCILobCharSetForm (
    OCIEnv* envhp,
    OCIError* errhp,
    const(OCILobLocator)* locp,
    ub1* csfrm);

sword OCILobCharSetId (
    OCIEnv* envhp,
    OCIError* errhp,
    const(OCILobLocator)* locp,
    ub2* csid);
...
sword OCILobDisableBuffering (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* locp);

sword OCILobEnableBuffering (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* locp);
...
sword OCILobFileExists (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* filep,
    int* flag);

sword OCILobFileGetName (
    OCIEnv* envhp,
    OCIError* errhp,
    const(OCILobLocator)* filep,
    OraText* dir_alias,
...
sword OCILobFileIsOpen (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* filep,
    int* flag);

sword OCILobFileOpen (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* filep,
    ub1 mode);

sword OCILobFileSetName (
    OCIEnv* envhp,
    OCIError* errhp,
    OCILobLocator** filepp,
...
sword OCILobFlushBuffer (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* locp,
    ub4 flag);

sword OCILobFreeTemporary (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* locp);

sword OCILobGetChunkSize (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* locp,
    ub4* chunksizep);
...
sword OCILobIsTemporary (
    OCIEnv* envp,
    OCIError* errhp,
    OCILobLocator* locp,
    int* is_temporary);

sword OCILobLoadFromFile (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* dst_locp,
    OCILobLocator* src_filep,
...
sword OCILobGetDeduplicateRegions (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* locp,
    OCILobRegion* regp,
...
sword OCILobGetLength2 (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* locp,
    oraub8* lenp);

sword OCILobLoadFromFile2 (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* dst_locp,
    OCILobLocator* src_filep,
...
sword OCILobArrayRead (
    OCISvcCtx* svchp,
    OCIError* errhp,
    ub4* array_iter,
    OCILobLocator** lobp_arr,
    oraub8* byte_amt_arr,
    oraub8* char_amt_arr,
    oraub8* offset_arr,
    void** bufp_arr,
...
sword OCILobGetStorageLimit (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* lobp,
    oraub8* limitp);

sword OCILobGetOptions (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCILobLocator* lobp,
    ub4 optypes,
...
sword OCISecurityCloseWallet (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttWallet* wallet);

sword OCISecurityCreateWallet (
    OCISecurity* osshandle,
    OCIError* error_handle,
    size_t wrllen,
    OraText* wallet_resource_locator,
...
sword OCISecurityDestroyWallet (
    OCISecurity* osshandle,
    OCIError* error_handle,
    size_t wrllen,
    OraText* wallet_resource_locator,
...
sword OCISecurityStorePersona (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona** persona,
    nzttWallet* wallet);

sword OCISecurityOpenPersona (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona);

sword OCISecurityClosePersona (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona);

sword OCISecurityRemovePersona (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona** persona);

sword OCISecurityCreatePersona (
    OCISecurity* osshandle,
    OCIError* error_handle,
...
sword OCISecuritySetProtection (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
...
sword OCISecurityGetProtection (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
    nzttcef crypto_engine_function,
...
sword OCISecurityRemoveIdentity (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttIdentity** identity_ptr);

sword OCISecurityCreateIdentity (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttIdentType type,
...
sword OCISecurityAbortIdentity (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttIdentity** identity_ptr);

sword OCISecurityFreeIdentity (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttIdentity** identity_ptr);

sword OCISecurityStoreTrustedIdentity (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttIdentity** identity_ptr,
    nzttPersona* persona);

sword OCISecuritySign (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
...
sword OCISecuritySignExpansion (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
    size_t inputlen,
...
sword OCISecuritySignDetExpansion (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
    size_t input_length,
...
sword OCISecurityVerifyDetached (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
    nzttces signature_state,
...
sword OCISecurityPKEncryptExpansion (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
...
sword OCISecurityEncryptExpansion (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
    size_t input_length,
...
sword OCISecurityKeyedHashExpansion (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
    size_t input_length,
...
sword OCISecurityHashExpansion (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
    size_t input_length,
...
sword OCISecurityRandomNumber (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttPersona* persona,
    uword* random_number_ptr);

sword OCISecurityInitBlock (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttBufferBlock* buffer_block);

sword OCISecurityReuseBlock (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttBufferBlock* buffer_block);

sword OCISecurityPurgeBlock (
    OCISecurity* osshandle,
    OCIError* error_handle,
    nzttBufferBlock* buffer_block);

sword OCISecuritySetBlock (
    OCISecurity* osshandle,
    OCIError* error_handle,
    uword flags_to_set,
...
sword OCIExtractSetKey (
    ...
    const(void)* defval,
    const(sb4)* intrange,
    const(OraText*)* strlist);

sword OCIExtractFromFile (
    void* hndl,
    OCIError* err,
    ub4 flag,
    OraText* filename);
...
sword OCIPicklerTdsCreateElementNumber (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerTds* tdsh,
    ub1 prec,
...
sword OCIPicklerTdsCreateElementChar (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerTds* tdsh,
    ub2 len,
...
sword OCIPicklerTdsCreateElementVarchar (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerTds* tdsh,
    ub2 len,
...
sword OCIPicklerTdsCreateElementRaw (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerTds* tdsh,
    ub2 len,
...
sword OCIPicklerTdsCreateElement (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerTds* tdsh,
    OCITypeCode dty,
...
sword OCIPicklerImageAddScalar (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh,
    void* scalar,
...
sword OCIPicklerImageAddNullScalar (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh);

sword OCIPicklerImageGenerate (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh);

sword OCIPicklerImageGetScalarSize (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh,
    ub4 attrno,
...
sword OCIPicklerImageGetScalar (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh,
    ub4 attrno,
...
sword OCIPicklerImageCollBegin (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh,
    const(OCIPicklerTds)* colltdsh);

sword OCIPicklerImageCollAddScalar (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh,
    void* scalar,
...
sword OCIPicklerImageCollEnd (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh);

/* should take svcctx for locator stuff */
sword OCIPicklerImageCollBeginScan (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh,
...
sword OCIPicklerImageCollGetScalarSize (
    OCIEnv* env,
    OCIError* err,
    const(OCIPicklerTds)* coll_tdsh,
    ub4* size);

sword OCIPicklerImageCollGetScalar (
    OCIEnv* env,
    OCIError* err,
    OCIPicklerImage* imgh,
    void* buf,
...
sword OCIAnyDataIsNull (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCIAnyData* sdata,
    int* isnull);

sword OCIAnyDataConvert (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCITypeCode tc,
    OCIType_* type,
...
sword OCIAnyDataEndCreate (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCIAnyData* sdata);

sword OCIAnyDataAccess (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCIAnyData* sdata,
    OCITypeCode tc,
...
sword OCIAnyDataGetCurrAttrNum (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCIAnyData* sdata,
    ub4* attrnum);

sword OCIAnyDataAttrGet (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCIAnyData* sdata,
    OCITypeCode tc,
...
/*
   ...
   NOTES
     ...
     OCIAnyDataSet will end up pointing to the passed in OCIType_ parameter.
     It is the responsibility of the caller to ensure that the OCIType_ is
     longer lived (has allocation duration >= the duration of the OCIAnyData
     if the OCIType_ is a transient one, allocation/pin duration >= duration of
     the OCIAnyData if the OCIType_ is a persistent one).

*/
sword OCIAnyDataSetBeginCreate (
    OCISvcCtx* svchp,
    OCIError* errhp,
...
/*
   ...
   NOTES
     ...
     deep copying (of OCIType_ information nor the data part.) is done in the
     ...
     OCIAnyDataSet.
*/
sword OCIAnyDataSetAddInstance (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCIAnyDataSet* data_set,
    OCIAnyData** data);
...
/*
  ...
  NOTE
    ...
    copying (of OCIType_ information nor the data part.) is done in the returned
...
*/
sword OCIAnyDataSetGetInstance (
    OCISvcCtx* svchp,
    OCIError* errhp,
    OCIAnyDataSet* data_set,
    OCIAnyData** data);
...
sword OCIFormatTUb2 ();
sword OCIFormatTUb4 ();
sword OCIFormatTUword ();
sword OCIFormatTUbig_ora ();
sword OCIFormatTSb1 ();
sword OCIFormatTSb2 ();
sword OCIFormatTSb4 ();
sword OCIFormatTSword ();
sword OCIFormatTSbig_ora ();
sword OCIFormatTEb1 ();
sword OCIFormatTEb2 ();
sword OCIFormatTEb4 ();
sword OCIFormatTEword ();
sword OCIFormatTChar ();
sword OCIFormatTText ();
sword OCIFormatTDouble ();
sword OCIFormatTDvoid ();
sword OCIFormatTEnd ();
...
*/
sword OCIMultiByteInSizeToWideChar (
    void* envhp,
    OCIWchar* dst,
    size_t dstsz,
    const(OraText)* src,
...
/*
   ...
   rsize(OUT)
     ...
     If it is NULL pointer, nothing to return.
*/
sword OCIWideCharInSizeToMultiByte (
    void* envhp,
    OraText* dst,
    size_t dstsz,
    const(OCIWchar)* src,
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsAlnum (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsAlpha (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsCntrl (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsDigit (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsGraph (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsLower (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsPrint (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsPunct (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsSpace (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsUpper (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsXdigit (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar for testing.
*/
int OCIWideCharIsSingleByte (void* envhp, OCIWchar wc);
...
/*
   ...
   wc(IN)
     Wchar to search for.
*/
OCIWchar* OCIWideCharStrrchr (void* envhp, const(OCIWchar)* wstr, OCIWchar wc);
...
*/
size_t OCIWideCharStrCaseConversion (
    void* envhp,
    OCIWchar* wdststr,
    const(OCIWchar)* wsrcstr,
    ub4 flag);
...
*/
size_t OCIMultiByteStrnDisplayLength (
    void* envhp,
    const(OraText)* str1,
    size_t n);
...
/*
   ...
   flag(IN)
     ...
     linguistic setting in the locale will be used for case conversion.
*/
size_t OCIMultiByteStrCaseConversion (
    void* envhp,
    OraText* dststr,
    const(OraText)* srcstr,
    ub4 flag);
...
/*
   ...
   envhp(IN/OUT)
     ...
     OCICharsetUcs2ToMb().
*/
int OCICharSetConversionIsReplacementUsed (void* envhp);
...
*/
sword OCINlsEnvironmentVariableGet (
    void* valp,
    size_t size,
    ub2 item,
    ub2 charset,
...
sword OCIThreadKeyGet (
    void* hndl,
    OCIError* err,
    OCIThreadKey* key,
    void** pValue);

sword OCIThreadKeySet (
    void* hndl,
    OCIError* err,
    OCIThreadKey* key,
    void* value);
...
sword OCIThreadCreate (
    void* hndl,
    OCIError* err,
    void function (void*) start,
    void* arg,
    OCIThreadId* tid,
    OCIThreadHandle* tHnd);
...
alias OCIBindRowCallback = int function (void* ctx);
alias OCIFetchRowCallback = int function (void* ctx);

/*------------------ Begin OCI Row Callback Interfaces ----------------------*/

/*--------------- Begin OCI Client Notification Interfaces ------------------*/

alias OCISubscriptionNotify = uint function (
    void* ctx,
...
sword OCISubscriptionUnRegister (
    OCISvcCtx* svchp,
    OCISubscription* subscrhp,
    OCIError* errhp,
    ub4 mode);

sword OCISubscriptionDisable (
    OCISubscription* subscrhp,
    OCIError* errhp,
    ub4 mode);

sword OCISubscriptionEnable (
    OCISubscription* subscrhp,
    OCIError* errhp,
    ub4 mode);
...
sword OCIDateTimeSysTimeStamp (
    void* hndl,
    OCIError* err,
    OCIDateTime* sys_date);

sword OCIDateTimeAssign (
    void* hndl,
    OCIError* err,
...
sword OCIDateTimeCheck (
    void* hndl,
    OCIError* err,
    const(OCIDateTime)* date,
    ub4* valid);

sword OCIDateTimeConvert (
    void* hndl,
    OCIError* err,
    OCIDateTime* indate,
    OCIDateTime* outdate);

sword OCIDateTimeSubtract (
    void* hndl,
    OCIError* err,
    OCIDateTime* indate1,
    OCIDateTime* indate2,
...
sword OCIIntervalFromNumber (
    void* hndl,
    OCIError* err,
    OCIInterval* inter,
    OCINumber* number);

sword OCIIntervalFromText (
    void* hndl,
    OCIError* err,
...
sword OCIIntervalCheck (
    void* hndl,
    OCIError* err,
    const(OCIInterval)* interval,
    ub4* valid);

sword OCIIntervalAssign (
    void* hndl,
    OCIError* err,
    const(OCIInterval)* ininter,
    OCIInterval* outinter);

sword OCIIntervalSetYearMonth (
    void* hndl,
    OCIError* err,
    sb4 yr,
    sb4 mnth,
...
sword OCIDateTimeGetTimeZoneName (
    void* hndl,
    OCIError* err,
    const(OCIDateTime)* datetime,
    ub1* buf,
...
sword OCIKerbAttrSet (
    OCISession* trgthndlp,
    ub4 cred_use,
    ub1* ftgt_ticket,
    ub4 ticket_len,
    ub1* session_key,
