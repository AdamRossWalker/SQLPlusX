...
enum OCI_LCR_XROW = 3; /* External Row LCR */
enum OCI_LCR_XDDL = 4; /* External DDL LCR */

/* DML Command Types -- must match with values defined in kngl.h */
enum OCI_LCR_ROW_CMD_INSERT = "INSERT";
enum OCI_LCR_ROW_CMD_DELETE = "DELETE";
enum OCI_LCR_ROW_CMD_UPDATE = "UPDATE";
enum OCI_LCR_ROW_CMD_COMMIT = "COMMIT";
enum OCI_LCR_ROW_CMD_LOB_WRITE = "LOB WRITE";
enum OCI_LCR_ROW_CMD_LOB_TRIM = "LOB TRIM";
enum OCI_LCR_ROW_CMD_LOB_ERASE = "LOB ERASE";
enum OCI_LCR_ROW_CMD_ROLLBACK = "ROLLBACK";
enum OCI_LCR_ROW_CMD_START_TX = "START_TX"; /* start transaction */

/* LCR Extra Attribute Name -- must match with values defined in knll.h */
enum OCI_LCR_ATTR_THREAD_NO = "THREAD#";
enum OCI_LCR_ATTR_ROW_ID = "ROW_ID";
enum OCI_LCR_ATTR_SESSION_NO = "SESSION#";
enum OCI_LCR_ATTR_SERIAL_NO = "SERIAL#";
enum OCI_LCR_ATTR_USERNAME = "USERNAME";
enum OCI_LCR_ATTR_TX_NAME = "TX_NAME";

/* below are non first class LCR field specific */
enum OCI_LCR_ATTR_EDITION_NAME = "EDITION_NAME";
enum OCI_LCR_ATTR_MESSAGE_TRACKING_LABEL = "MESSAGE_TRACKING_LABEL";

/* the maximum total number of attributes, total of extra attributes
 * plus non first class LCR field.  */
enum OCI_LCR_MAX_ATTRIBUTES = 8;

/* Row LCR column value types used in OCILCRRowColumnInfoGet/Set functions. */
enum OCI_LCR_ROW_COLVAL_OLD = 0; /* OLD columns */
enum OCI_LCR_ROW_COLVAL_NEW = 1; /*  NEW columns */

/* maximum length for position */
enum OCI_LCR_MAX_POSITION_LEN = 64;

/* maximum length for txid */
enum OCI_LCR_MAX_TXID_LEN = 128;
 ...
 */
enum OCI_LCR_COLUMN_LOB_DATA = 0x00000001; /* col contains lob data */
enum OCI_LCR_COLUMN_LONG_DATA = 0x00000002; /* col contains long data*/
enum OCI_LCR_COLUMN_EMPTY_LOB = 0x00000004; /* col has an empty lob  */
enum OCI_LCR_COLUMN_LAST_CHUNK = 0x00000008; /* last chunk of current col*/
enum OCI_LCR_COLUMN_AL16UTF16 = 0x00000010; /* col is in AL16UTF16 fmt */
enum OCI_LCR_COLUMN_NCLOB = 0x00000020; /* col has NCLOB data */
enum OCI_LCR_COLUMN_XML_DATA = 0x00000040; /* col contains xml data */
enum OCI_LCR_COLUMN_XML_DIFF = 0x00000080; /* col contains xmldiff data */
enum OCI_LCR_COLUMN_ENCRYPTED = 0x00000100; /* col is encrypted */

/* OCI_LCR_COLUMN_UPDATED is set only for the modified columns in the NEW
 * column list of an update LCR.
 */
enum OCI_LCR_COLUMN_UPDATED = 0x00000200; /* col is updated */

/* Valid bit values for the flag parameter in the following APIS:
 * - OCILCRHeaderGet
 * - OCILCRHeaderSet
 */
enum OCI_ROWLCR_HAS_ID_KEY_ONLY = 0x00000001; /* only has ID key cols */
/* (0x00000002) is RESERVED */
/* (0x00000004) is RESERVED */
/* (0x00000008) is RESERVED */
enum OCI_ROWLCR_SEQ_LCR = 0x00000010; /* sequence lcr */
 ...
 */
enum OCI_XSTREAM_MORE_ROW_DATA = 0x00000001; /* LCR contains more data */

/* Valid mode flag for OCILCRHeaderGet and OCILCRRowColumnInfoGet functions */
enum OCILCR_NEW_ONLY_MODE = 0x0001; /* NEW columns only -- dont */
/* include OLD columns      */

/* Valid mode flag for OCIXStreamInFlush */
/* Synchronous mode for OCIXStreamInFlush */
enum OCIXSTREAM_IN_FLUSH_WAIT_FOR_COMPLETE = 0x00000001;
...
enum OCIXSTREAM_OUT_ATTACH_RESERVED_1 = 0x00000001;
/* Application is in charge of freeing the LCRs from the outbound server */
enum OCIXSTREAM_OUT_ATTACH_APP_FREE_LCR = 0x00000002;
...
sword OCIXStreamOutProcessedLWMSet (
    OCISvcCtx* svchp,
    OCIError* errhp,
...
*/
alias OCICallbackXStreamOutLCRProcess = int function (
    void* usrctxp,
    void* lcrp,
    ub1 lcrtyp,
    oraub8 flag);
...
/*
   ...
   RETURNS
    ...
    OCIXStreamOutLCRCallbackReceive immediately.
*/
alias OCICallbackXStreamOutChunkProcess = int function (
    void* usrctxp,
    oratext* column_name,
    ub2 column_name_len,
    ub2 column_dty,
...
*/
sword OCIXStreamOutChunkReceive (
    OCISvcCtx* svchp,
    OCIError* errhp,
    oratext** column_name,
    ub2* column_name_len,
...
enum OCIXSTREAM_IN_ATTACH_RESTART_INBOUND = 0x00000001;
...
*/
alias OCICallbackXStreamInLCRCreate = int function (
    void* usrctxp,
    void** lcrp,
    ub1* lcrtyp,
    oraub8* flag);
...
/*
   ...
   RETURNS
    ...
    OCIXStreamInLCRCallbackSend immediately.
*/
alias OCICallbackXStreamInChunkCreate = int function (
    void* usrctxp,
    oratext** column_name,
    ub2* column_name_len,
    ub2* column_dty,
