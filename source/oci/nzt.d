 ...
 */
enum NZT_DEFAULT_WRL = cast(text*) "default:";
enum NZT_SQLNET_WRL = cast(text*) "sqlnet:";
enum NZT_FILE_WRL = cast(text*) "file:";
enum NZT_ENTR_WRL = cast(text*) "entr:";
enum NZT_MCS_WRL = cast(text*) "mcs:";
enum NZT_ORACLE_WRL = cast(text*) "oracle:";
enum NZT_REGISTRY_WRL = cast(text*) "reg:";

enum nzttwrl
{
    NZTTWRL_DEFAULT = 1, /* Default, use SNZD_DEFAULT_FILE_DIRECTORY */
    NZTTWRL_SQLNET = 2, /* Use oss.source.my_wallet in sqlnet.ora file */
    NZTTWRL_FILE = 3, /* Find the oracle wallet in this directory */
    NZTTWRL_ENTR = 4, /* Find the entrust profile in this directory */
    NZTTWRL_MCS = 5, /* WRL for Microsoft */
    NZTTWRL_ORACLE = 6, /* Get the wallet from OSS db */
    NZTTWRL_NULL = 7, /* New SSO defaulting mechanism */
    NZTTWRL_REGISTRY = 8 /* Find the wallet in Windows Registry */
}
...
struct nzttWalletObj; /* For wallet object */
struct nzssEntry; /* For secretstore */
...
enum nzttces
{
    ...
    NZTTCES_END = 2, /* End processing input */
    NZTTCES_RESET = 3 /* Reset processing and skip generating output */
}
...
enum nzttcef
{
    ...
    NZTTCEF_SIGNATURE = 2, /* Signature combined with content */
    NZTTCEF_ENVELOPING = 3, /* Signature and encryption with content */
    NZTTCEF_PKENCRYPTION = 4, /* Encryption for one or more recipients */
    NZTTCEF_ENCRYPTION = 5, /* Symmetric encryption */
    NZTTCEF_KEYEDHASH = 6, /* Keyed hash/checkusm */
    NZTTCEF_HASH = 7, /* Hash/checsum */
    NZTTCEF_RANDOM = 8, /* Random byte generation */

    NZTTCEF_LAST = 9 /* Used for array size */
}
...
enum nzttState
{
    ...
    NZTTSTATE_REQUESTED = 1, /* cert-request */
    NZTTSTATE_READY = 2, /* certificate */
    NZTTSTATE_INVALID = 3, /* certificate */
    NZTTSTATE_RENEWAL = 4 /* renewal-requested */
}
...
enum nzttVersion
{
    ...
    NZTTVERSION_X509v3 = 2, /* X.509v3 */

    /* Symmetric */

    NZTTVERSION_INVALID_TYPE = 3 /* For Initialization */
}
...
enum nzttCipherType
{
    ...
    NZTTCIPHERTYPE_DES = 2, /* DES */
    NZTTCIPHERTYPE_RC4 = 3, /* RC4 */
    NZTTCIPHERTYPE_MD5DES = 4, /* DES encrypted MD5 with salt (PBE) */
    NZTTCIPHERTYPE_MD5RC2 = 5, /* RC2 encrypted MD5 with salt (PBE) */
    NZTTCIPHERTYPE_MD5 = 6, /* MD5 */
    NZTTCIPHERTYPE_SHA = 7 /* SHA */
}
...
enum nztttdufmt
{
    ...
    NZTTTDUFMT_RSAPAD = 2, /* RSA padded format */
    NZTTTDUFMT_ORACLEv1 = 3, /* Oracle v1 format */
    NZTTTDUFMT_LAST = 4 /* Used for array size */
}
...
enum nzttValState
{
    ...
    NZTTVALSTATE_GOOD = 2, /* Validated */
    NZTTVALSTATE_REVOKED = 3 /* Failed to validate */
}
...
{
    NZTTPOLICY_NONE = 0,
    NZTTPOLICY_RETRY_1 = 1, /* number of retries for decryption = 1 */
    NZTTPOLICY_RETRY_2 = 2, /* number of retries for decryption = 2 */
    NZTTPOLICY_RETRY_3 = 3 /* number of retries for decryption = 3 */
}
...
alias nzttKPUsage = uint;
/* IF new types are added nztiMUS should be changed */
enum NZTTKPUSAGE_NONE = 0;
enum NZTTKPUSAGE_SSL = 1; /* SSL Server */
enum NZTTKPUSAGE_SMIME_ENCR = 2;
enum NZTTKPUSAGE_SMIME_SIGN = 4;
enum NZTTKPUSAGE_CODE_SIGN = 8;
enum NZTTKPUSAGE_CERT_SIGN = 16;
enum NZTTKPUSAGE_SSL_CLIENT = 32; /* SSL Client */
enum NZTTKPUSAGE_INVALID_USE = 0xffff;

/*
 * Timestamp as 32 bit quantity in UTC.
 */
alias nzttTStamp = ubyte[4];
 ...
 */
nzerror nztSign (nzctx*, nzttPersona*, nzttces, ub4, ub1*, nzttBufferBlock*);
 ...
 *    NZERROR_TK_NOTSUPP   Function not supported with persona.
 */
nzerror nztValidate (nzctx*, nzttPersona*, nzttIdentity*, int*);
 ...
 *    NZERROR_TK_NOTSUPP   Function not supported with persona.
 */
nzerror nztHash (nzctx*, nzttPersona*, nzttces, ub4, ub1*, nzttBufferBlock*);
 ...
 *
 */
nzerror nztCompareDN (nzctx*, ub1*, ub4, ub1*, ub4, int*);
 ...
 *    NZERROR_TK_NOTSUPP   Function not supported with persona.
 */
nzerror nztEncrypt (nzctx*, nzttPersona*, nzttces, ub4, ub1*, nzttBufferBlock*);
 ...
 *    NZERROR_TK_NOTSUPP   Function not supported with persona.
 */
nzerror nztDecrypt (nzctx*, nzttPersona*, nzttces, ub4, ub1*, nzttBufferBlock*);
...
nzerror nztiae_IsAuthEnabled (nzctx* ctx, ub2 ncipher, int* authEnabled);
...
nzerror nztiee_IsEncrEnabled (nzctx* ctx, ub2 ncipher, int* EncrEnabled);
...
nzerror nztihe_IsHashEnabled (nzctx* ctx, ub2 ncipher, int* hashEnabled);
...
nzerror nztGetVersion (nzctx* ctx, nzttIdentity* identity, nzstrc* pVerStr);
...
nzerror nztSearchNZDefault (nzctx* ctx, int* search);

nzerror nztSetLightWeight (nzctx* ctx, int flag);
