...
sword obindps (
    ...
    sb4 fmtl,
    sword fmtt);
sword obreak (cda_def* lda);
sword ocan (cda_def* cursor);
sword oclose (cda_def* cursor);
sword ocof (cda_def* lda);
sword ocom (cda_def* lda);
sword ocon (cda_def* lda);
...
sword odessp (
    ...
    ub4* spare,
    ub4* arrsiz);
sword oerhms (cda_def* lda, sb2 rcode, OraText* buf, sword bufsiz);
sword oermsg (sb2 rcode, OraText* buf);
sword oexec (cda_def* cursor);
sword oexfet (cda_def* cursor, ub4 nrows, sword cancel, sword exact);
sword oexn (cda_def* cursor, sword iters, sword rowoff);
sword ofen (cda_def* cursor, sword nrows);
sword ofetch (cda_def* cursor);
sword oflng (
    cda_def* cursor,
    sword pos,
    ub1* buf,
...
sword oopen (
    ...
    OraText* uid,
    sword uidl);
sword oopt (cda_def* cursor, sword rbopt, sword waitopt);
sword oparse (
    cda_def* cursor,
    OraText* sqlstm,
    sb4 sqllen,
    sword defflg,
    ub4 lngflg);
sword orol (cda_def* lda);
sword osetpi (cda_def* cursor, ub1 piece, void* bufp, ub4* lenp);
void sqlld2 (cda_def* lda, OraText* cname, sb4* cnlen);
void sqllda (cda_def* lda);

/* non-blocking functions */
sword onbset (cda_def* lda);
sword onbtst (cda_def* lda);
sword onbclr (cda_def* lda);
sword ognfd (cda_def* lda, void* fdp);
...
sword orlon (
    ...
    sword pswdl,
    sword audit);
sword osql3 (cda_def* cda, OraText* sqlstm, sword sqllen);
