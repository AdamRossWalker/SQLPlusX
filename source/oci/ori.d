...
/*
  ...
  EXAMPLES
    ...
    EXAMPLE 1
      ...
      OCIType_ *stu_tdo;            /o student type tdo o/

      OCIRef_    *stu2_ref;         /o object reference to student object o/
      ...
      if (OCIObjectPinTable(env, err, svc, "ORACLEU", sizeof("ORACLEU"),
          "STUDENT_TABLE", sizeof("STUDENT_TABLE"), (OCIRef_ *)0,
      ...
      if (OCICacheFlush(env, err, svc, (void *)0, ((OCIRef_*)(*)())0,
                       (OCIRef_ *)0) != OCI_SUCCESS)
          /o error handling code o/
...
sword OCIObjectUnmarkByRef (OCIEnv* env, OCIError* err, OCIRef_* ref_);
/*
...
sword OCIObjectMarkDeleteByRef (OCIEnv* env, OCIError* err, OCIRef_* object_ref);
/*
...
sword OCIObjectGetPrimaryKeyTypeRef (
    OCIEnv* env,
    OCIError* err,
    const(OCISvcCtx)* svc,
    void* table,
...
/*------------------------- OCIObjectExists --------------------------------*/
sword OCIObjectExists (OCIEnv* env, OCIError* err, void* ins, int* exist);
/*
...
/*---------------------------- OCIObjectIsLocked --------------------------*/
sword OCIObjectIsLocked (OCIEnv* env, OCIError* err, void* ins, int* lock);
/*
...
/*------------------------- OCIObjectIsDirty ------------------------------*/
sword OCIObjectIsDirty (OCIEnv* env, OCIError* err, void* ins, int* dirty);
/*
...
sword OCICacheFlush (
    ...
    const(OCISvcCtx)* svc,
    void* context,
    OCIRef_* function (void* context, ub1* last) get,
    OCIRef_** ref_);
/*
...
/*--------------------------- OCICacheRefresh -------------------------------*/
sword OCICacheRefresh (
    OCIEnv* env,
    OCIError* err,
    const(OCISvcCtx)* svc,
    OCIRefreshOpt option,
    void* context,
    OCIRef_* function (void* context) get,
    OCIRef_** ref_);
/*
...
sword OCIObjectIsLoaded (OCIEnv* env, OCIError* err, void* ins, int* load);

sword OCIObjectIsDirtied (OCIEnv* env, OCIError* err, void* ins, int* dirty);

sword OCICacheGetObjects (
    OCIEnv* env,
    OCIError* err,
    const(OCISvcCtx)* svc,
    OCIObjectProperty property,
    void* client_context,
    void function (void* client_context, void* object) client_callback);

sword OCICacheRegister (
    OCIEnv* env,
    OCIError* err,
    OCIObjectEvent event,
    void* client_context,
    void function (void* client_context, OCIObjectEvent event, void* object) client_callback);

sword OCICacheFlushRefresh (
    OCIEnv* env,
    OCIError* err,
    const(OCISvcCtx)* svc,
    void* context,
